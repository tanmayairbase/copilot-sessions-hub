...
const api: RendererApi = {
  ...
  listStarredMessages: async (query: string) => ipcRenderer.invoke('sessions:list-starred', query),
  ...
  setMessageStarred: async (sessionId: string, messageId: string, starred: boolean) =>
    ipcRenderer.invoke('sessions:set-message-starred', sessionId, messageId, starred)
}
